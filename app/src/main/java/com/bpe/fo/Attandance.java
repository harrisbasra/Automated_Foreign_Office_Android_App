...
public class Attandance extends AppCompatActivity {
    ...
    private ActivityAttandanceBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityAttandanceBinding.inflate(getLayoutInflater());
...
//        timee2.setText(A);
        ...
        i1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent hi = new Intent(Attandance.this, Addprogress.class);
                startActivity(hi);
            }
        });
        //.................................................................
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i40083 = new Intent(Attandance.this, ViewReports.class);
